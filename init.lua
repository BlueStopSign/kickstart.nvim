...
vim.opt.listchars:append({
   precedes = '<', -- Icon shown at the left edge when text extends left
   extends  = '>', -- Icon shown at the right edge when text extends right
})
  ...
  { -- You can easily change to a different colorscheme.
   ...
   { -- Collection of various small independent plugins/modules
      ...
      config = function()
         ...
         --
         -- Examples:
         --  - va)  - [V]isually select [A]round [)]paren    opts = {
